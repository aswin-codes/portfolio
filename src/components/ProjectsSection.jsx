...
const ProjectsSection = () => {
  return (
    <section id="projects" className="py-16 bg-gradient-to-br from-gray-900 to-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold text-gray-200 mb-12 text-center">Projects</h2>
